        ...
        <form action="code/proses/update-delete/update/update_pasien.php" method="POST">
            ...
            <table id="tabel-pendaftaran">
                ...
                ?>
                    ...
                    <tr>
                        <td><input type="text" name='TeleponPasien' size="25px" maxlength="13" value="<?php echo $isi['TeleponPasien']; ?>"></td>
                    </tr>
                    ...
                    <tr>
                        <td><textarea name="Keterangan" cols="28" rows="5" maxlength="" placeholder="ketikkan Keterangan pasien.." required><?php echo $isi['Keterangan']; ?></textarea>&nbsp;&nbsp;&nbsp; <input class="button" type="submit" value="Update">
                     </td>
                    </tr>
