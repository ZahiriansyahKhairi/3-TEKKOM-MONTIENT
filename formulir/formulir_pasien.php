...
<form action="code/proses/input/input_pasien.php" method="POST">
    ...
    <tr>
        <td><textarea name="AlamatPasien" cols="28" rows="5" maxlength="" placeholder="ketikkan alamat pasien.." required></textarea>
        </td>
    </tr>
    ...
    <tr>
        <td><input type="text" name="TeleponPasien" size="25px" maxlength="13" placeholder="ketikkan nomor telepon.." required></td>
    </tr>
    ...
    <tr>
        <td><textarea name="Keterangan" cols="28" rows="5" maxlength="" placeholder="ketikkan Keterangan pasien.." required></textarea>&nbsp;&nbsp;&nbsp; 
