...
<form action="halaman_utama.php?tabel_resep=$tabel_resep" method="post">
	<table width="100%">
		<tr>
			<td>
				<a href="halaman_utama.php?formulir_resep=$formulir_resep"><input class="button" type="button" value="Tambah"></a>
				<a href="Halaman_kosong.php?pdf_resep=$pdf_resep" target="_blank"><input class="button" type="button" value="Print"></a>
			</td>
			<td align="right">
