...
$updatePasien = "UPDATE pasien set KodePasien='$KodePasien' , NamaPasien='$NamaPasien', AlamatPasien='$AlamatPasien' , GenderPasien='$GenderPasien' , UmurPasien='$UmurPasien' , TeleponPasien='$TeleponPasien' , Keterangan='$Keterangan' where KodePasien='$KodePasien'";
